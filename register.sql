...
INSERT INTO cr_person( sur_name,  give_name, patronymic, date_of_birth,  passport_seria, passport_number, passport_date, certificate_number,certificate_date )
  VALUES('Петров','Виктор','Сергеевич' ,'1995-03-18', '1234','123456','2015-04-11',null, null);

INSERT INTO cr_person( sur_name,  give_name, patronymic, date_of_birth,  passport_seria, passport_number, passport_date,certificate_number,  certificate_date)
    VALUES('Васильева','Ирина','Петровна' ,'1997-08-11', '4321','654321','2017-09-19', null, null);

INSERT INTO cr_person( sur_name,  give_name, patronymic, date_of_birth,  passport_seria, passport_number, passport_date,certificate_number,  certificate_date)
        VALUES('Васильева','Евгения','Павловна' ,'2016-01-11', null, null,null, '456123', '2016-01-18');

INSERT INTO cr_person( sur_name,  give_name, patronymic, date_of_birth,  passport_seria, passport_number, passport_date,certificate_number,  certificate_date)
        VALUES('Васильева','Александр','Павлович' ,'2018-01-11', null, null,null, '321654', '2018-11-09');
...
CREATE TABLE cr_address_person(
   ...
   FOREIGN KEY(address_id) REFERENCES cr_address(address_code) ON DELETE RESTRICT,
